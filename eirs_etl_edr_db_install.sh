...
insert ignore into app.sys_param (tag,value, feature_name,type,active,remark,description,user_type,modified_by) values ('CELLCARD_CC_EDR_FILE_PATTERN','CELLCARD_EIRID-17-8','EDR',0,1,'','file pattern for CELLCARD CC_EDR1  ','system','system');
insert ignore into app.sys_param (tag,value, feature_name,type,active,remark,description,user_type,modified_by) values ('CELLCARD_CC_EDR2_FILE_PATTERN','CELLCARD_EIRID-17-8','EDR',0,1,'','file pattern for CELLCARD CC_EDR2 ','system','system');
insert ignore into app.sys_param (tag,value, feature_name,type,active,remark,description,user_type,modified_by) values ('SMART_SM_EDR2_FILE_PATTERN','SMART_EIRID-14-8','EDR',0,1,'','file pattern for SMART SM_EDR2 ','system','system');
insert ignore into app.sys_param (tag,value, feature_name,type,active,remark,description,user_type,modified_by) values ('METFONE_MF_EDR2_FILE_PATTERN','METFONE_EIRID-16-8','EDR',0,1,'','file pattern for  METFONE MF_EDR2','system','system');
insert ignore into app.sys_param (tag,value, feature_name,type,active,remark,description,user_type,modified_by) values ('SEATEL_ST_EDR2_FILE_PATTERN','SEATEL_EIRID-15-8','EDR',0,1,'','file pattern for SEATEL ST_EDR2 ','system','system');
insert ignore into app.sys_param (tag,value, feature_name,type,active,remark,description,user_type,modified_by) values ('CELLCARD_CC_EDR1_FILE_PATTERN','CELLCARD_EIRID-17-8','EDR',0,1,'','file pattern for CELLCARD CC_EDR1 ','system','system');
insert ignore into app.sys_param (tag,value, feature_name,type,active,remark,description,user_type,modified_by) values ('SMART_SM_EDR1_FILE_PATTERN','SMART_EIRID-14-8','EDR',0,1,'','file pattern for SMART SM_EDR1 ','system','system');
insert ignore into app.sys_param (tag,value, feature_name,type,active,remark,description,user_type,modified_by) values ('METFONE_MF_EDR1_FILE_PATTERN','METFONE_EIRID-16-8','EDR',0,1,'','file pattern for METFONE MF_EDR1 ','system','system');
insert ignore into app.sys_param (tag,value, feature_name,type,active,remark,description,user_type,modified_by) values ('SEATEL_ST_EDR1_FILE_PATTERN' ,'SEATEL_EIRID-15-8','EDR',0,1,'','file pattern for SEATEL ST_EDR1','system','system');
